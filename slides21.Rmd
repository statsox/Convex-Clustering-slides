...
<img src="http://i.imgur.com/mRk1JqU.png" style="width: 900px;"/>
...
<img src="http://i.imgur.com/u6ZWGJZ.png" style="width: 600px;"/>
...
<img src="http://i.imgur.com/sfZURue.png" style="width: 800px;"/>
...
- Good algorithmic behavior: 
    ...
    - <span style="color: orange">Stability</span> with respect to data and other inputs<br /><br />
- Good, data-driven way to select cluster number and extent<br /><br />

#### Solution:

- Solve combinatorially hard problem with its <span style="color: orange">convex surrogate</span>: 
